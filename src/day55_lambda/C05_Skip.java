...
public class C05_Skip {
    ...
    skip(list.size()-1) => List’in uzunluğunun 1 eksiğini yazarsak son elemanı yazdırırız.
        ...
        List<String> yemahhh = new ArrayList<>(Arrays.asList("küşleme", "soğanli", "trileçe", "bicibici", "büryan", "Welemen", "cacix", "kokerec", "yağlama", "güvec", "arabAşi", "tantuni"));
