...
// Sırasız akışlar için, herhangi bir kararlılık garantisi verilmez. Stream return eder.
    ...
    public static void main(String[] args) {
        ...
        yemahhh
                .stream()
                        .distinct() //Ayni elemanlari listeden cikarir
                                .map(String::toUpperCase)  //Method Referansi cagirdik zaten var bu // alternatifi---> map(t->t.toUpperCase());
                                        .sorted()
        ...
        yemahhh
                ...
                .distinct()
                //.map(t->(int)Math.pow(t.length(),2)) //yukaridaki iki map'in alternatifi tek map'te
                .sorted(Comparator.reverseOrder())
                .forEach(SeedMethods::yazdir);
